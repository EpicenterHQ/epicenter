...
- **Relates:** [ADR-0349](0349-local-blobs-belong-to-the-app-on-this-device.md) (where this record's `upload`, `download`, and `purge` vocabulary survives, as verbs on `epicenter.blobs` against the authority)
