...
- **Amended by:** [ADR-0375](0375-local-and-personal-data-preserve-named-account-ownership.md) at defining a library solely by account identity or local ownership: Personal and Shared are distinct libraries for the same signed-in person, while fixed page ownership and close-before-replacement remain.
- **Amended by:** [ADR-0392](0392-product-boundaries-provide-required-resource-handles.md) at "one library": a page owns one auth generation and holds the device store and the account's libraries at once. Close-before-replacement on an account change stands.
