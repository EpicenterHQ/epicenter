...
- **Date:** 2026-06-25
- **Amended by:** [ADR-0326](0326-the-deployment-names-the-authority-and-a-person-never-types-one.md) at the delivery mechanism, replacing the persisted destination setting with deployment configuration; [ADR-0375](0375-local-and-personal-data-preserve-named-account-ownership.md) at the hosted-only sign-in restriction, introducing named-user self-hosted sessions without selecting a provider.
