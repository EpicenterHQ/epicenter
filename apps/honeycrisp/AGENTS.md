...
The `[notes=notes]` page captures one Account and owns one App across `/local`
...
- Do not render a store error to a person as the message. `routes/[notes=notes]/+page.svelte`
