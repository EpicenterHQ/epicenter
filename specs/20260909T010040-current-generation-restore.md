...
The subsequent physical-capture run passes using the connected BMW2002 Microphone.
It ran from isolated 1057265cfc with the same built UI to exclude concurrent blob
ownership edits; the new result does not validate that separate redesign.
